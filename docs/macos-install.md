...
当前开发源码使用 Electron 44，要求 **macOS 13 Ventura 或更新版本**；Apple Silicon 使用 `arm64`，Intel 使用 `x64`。此要求已写入打包配置。参见 [Electron 44 系统支持说明](https://www.electronjs.org/blog/electron-44-0)。以下发布记录描述的是已发布版本，不代表本地未发布修改已经在 Mac 上完成验证。
