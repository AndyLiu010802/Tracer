...
function animationPrompt(profile) {
  ...
  return 'Create ONE square 1024x1024 transparent PNG pixel-art animation sprite sheet for a desktop companion. ' +
    ...
    'Play every action forward in chronological order, never as a ping-pong or reversed sequence. Recovery must not undo the result: keep a caught fish out of the water, keep a mined gem out of the rock, keep a turned page turned, and keep completed marks or craft work intact. For fishing and mining, end with a calm successful catch or discovery pose; the next loop starts a new attempt instead of lowering the reward back into the scene. ' +
    'Design for fluid, quiet desktop playback: small deliberate gestures, stable feet and torso, relaxed shoulders, and a comfortable resting pose. Use close-spaced transitional poses around one careful action. Add fine finger or paw placement, eye direction and subtle tool contact. Avoid bouncing the whole body, exaggerated swings, busy particles or flashing effects. Keep tools consistently placed through the action. ' +
    'All 16 cells show the SAME recognizable complete full-body character, same outfit, face, hairstyle or fur markings, anatomy, proportions, palette, pixel scale and camera view. Lock the body center and planted feet to the exact same coordinates and scale in every cell. Use one calm purposeful gesture with quiet anticipation and a settled ending; no wandering, whole-body bouncing, repetitive fidgeting or extra decorative motion. ' +
